...
import ham1 from "../assets/햄1.jpg";
...
const Exam5_2 = () => {
  const [userImg, setUserImg] = useState(
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSH4wC2qnIrZWGMfsy3yEJ3-cSmPP8n6RibNA&s"
  );

  return <img src={ham1} />;
};

// JSX 예제3 : 로그인 여부에 따라 화면 다르게 보이기
...
const Exam5_4 = (props) => {
  return <h1>{props.isLogin ? "환영합니다" : "로그인해주세오"}</h1>;
};
...
const Exam5_5 = () => {
  ...
  const members = ["강아지", "고양이", "토끼", "햄스터", "새"];

  // JS 내장함수 중 배열을 하나씩 순차접근해서 콜백함수 내에 있는 내용 수행 후
  // 새로운 배열을 만들어 반환 -> map
  // filter 콜백함수 내에 있는 일부만 걸러서 사용
  // reduce 누적해서 사용

  // [<li>강아지</li>, <li>고양이</li>, <li>토끼</li>, <li>햄스터</li>, <li>새</li>]
  ...
  //   각 자식 컴포넌트가 고유한 key 속성을 가져야 한다는 규착 위배시 발생하는 경고!
